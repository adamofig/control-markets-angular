...
- Usally is references in lead Service, ToastAlertService, HttpService and Endpoints
- add endpints for leads.

```
  Leads: {
    Leads: 'api/lead',
    LeadsFiltered: 'api/lead/query',
  },
```
...
### 4) Starting building your collection table what every, change current ILead to your data bussiness.
