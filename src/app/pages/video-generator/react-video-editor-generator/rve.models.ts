...
export type Overlay = TextOverlay | ImageOverlay | ShapeOverlay | ClipOverlay | SoundOverlay | CaptionOverlay;
...
export interface CompositionProps {
  overlays: Overlay[]; // Replace with your actual Overlay type
  durationInFrames: number;
  width: number;
  height: number;
  fps: number;
...
export type ProgressResponse = { type: 'error'; message: string } | { type: 'progress'; progress: number } | { type: 'done'; url: string; size: number };
